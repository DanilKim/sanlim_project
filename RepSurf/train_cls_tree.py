...
from dataset.TreeDataLoader import TreeDataLoader
...
def test(model, loader, num_class=7, num_point=1024, num_votes=10, total_num=1):
    vote_correct = 0
    sing_correct = 0
...
def main(args):
    ...
    TRAIN_DATASET = TreeDataLoader(root=DATA_PATH, split='training')
    TEST_DATASET = TreeDataLoader(root=DATA_PATH, split='test')
